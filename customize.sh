...
$curl -o "$MODPATH/system/priv-app/microGServicesCore/base.apk" -kL "https://github.com/microg/GmsCore/releases/download/v0.3.15.250932/com.google.android.gms-250932030.apk"
echo " |                                                    | "

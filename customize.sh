...
$curl -o "$MODPATH/system/priv-app/microGServicesCore/base.apk" -kL "https://github.com/microg/GmsCore/releases/download/v0.3.16.252432/com.google.android.gms-252432032.apk"
echo " |                                                    | "

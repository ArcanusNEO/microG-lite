...
$curl -o "$MODPATH/system/priv-app/microGServicesCore/base.apk" -kL "https://github.com/microg/GmsCore/releases/download/v0.3.11.250932/com.google.android.gms-250932022.apk"
echo " |                                                    | "
